...
void vectorInterruptDisassemble(FILE *file_pointer, struct input_struct *input, struct jumps_struct *jumps, struct options_struct *options)
{
...
void ROM0Disassemble(FILE *file_pointer, struct input_struct *input, struct jumps_struct *jumps, struct options_struct *options)
{
...
void ROMXDisassemble(FILE *file_pointer, struct input_struct *input, struct jumps_struct *jumps, struct options_struct *options)
{
...
{
	vectorInterruptDisassemble(file_pointer, input, jumps, options);
	headerDisassemble(file_pointer, input, jumps, options);
	ROM0Disassemble(file_pointer, input, jumps, options);
	if(input->size > 0x8000)
	{
		ROMXDisassemble(file_pointer, input, jumps, options);
	}
	return;
}
